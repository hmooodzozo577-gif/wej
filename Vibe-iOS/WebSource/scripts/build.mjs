...
const assets={};for(const [name,type]of Object.entries(files)){const body=await fs.readFile('public/'+name,'utf8');assets['/'+name]={type,body,etag:'"'+crypto.createHash('sha256').update(body).digest('base64url').slice(0,27)+'"'};}
