...
export const EN: I18nDict = {
  ...
  detail: {
    ...
    majorCityDescription: 'One of the country’s largest urban centers by the population estimate in the data source.',
    capitalCityBestFor: 'Suits travelers who want to begin from the national administrative center and its main services.',
    majorCityBestFor: 'Suits travelers who prefer large cities and urban services.',
