...
export const EN: I18nDict = {
  ...
  results: {
    ...
    ratingTitle: 'How useful was this result?',
    ratingBody: 'Your anonymous rating helps improve Wejhaty and does not automatically change the current ranking.',
    ratingReasonsTitle: 'Why did you choose this rating? (optional)',
    ratingRelevant: 'Results feel relevant',
    ratingClear: 'Explanation is clear',
    ratingUnexpected: 'Results are unexpected',
    ratingMissingInfo: 'Information is missing',
    rateCountries: 'Rate each country’s usefulness (optional)',
    usefulYes: 'Useful',
    usefulNo: 'Not useful',
    submitRating: 'Send rating',
    ratingSaving: 'Saving…',
    ratingThanks: 'Thank you. Your rating was saved.',
    ratingFailed: 'The rating could not be saved. Please try again later.',
  },
  quiz: {
    ...base.quiz,
