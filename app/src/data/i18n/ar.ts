...
export const AR: I18nDict = {
  ...
  tourismInsights: {
    ...
    sourcePeriodLabel: 'بيانات السياحة: {year} (البنك الدولي)',
    ...
    disclaimer: 'أرقام الزوار الدوليين والإيرادات من البنك الدولي (بمصادر منظمة السياحة العالمية) — ليست قياسًا لحظيًا أو للسنة الحالية، وليست ميزانية سفر شخصية.',
  },
};
